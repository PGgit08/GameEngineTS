...
var Engine;
(function (Engine) {
    var TEntity = function (_Engine$TGameObject) {
        _inherits(TEntity, _Engine$TGameObject);

        function TEntity() {
            _classCallCheck(this, TEntity);

            // entity properties
            var _this = _possibleConstructorReturn(this, (TEntity.__proto__ || Object.getPrototypeOf(TEntity)).call(this));

            _this.children = [];
            _this.components = [];
            _this.transform = new Engine.Transform();
            return _this;
        }

        _createClass(TEntity, [{
            key: "update",
